...
| BF-23 | Lokales `qwen3:14b` liefert Endlos-Wiederholungen oder Zeichensalat | vermutlich Prompt-Cache-Wiederverwendung + KV-Cache `q8_0` + Flash-Attention auf Vulkan (Radeon 890M); auffaellig: `prompt_tokens = 0` bei genau diesen Antworten | nicht behoben; Modell nicht im Einsatz. Offene Luecke: LUNA prueft lokale Antworten nicht auf Plausibilitaet (Zeichensalat wuerde an den CEO gehen) | 2026-09-26 |
